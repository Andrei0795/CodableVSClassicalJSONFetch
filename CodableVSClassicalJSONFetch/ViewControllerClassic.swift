...
class ViewControllerClassic: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        statusLabel.text = viewModel.hasInternetConnection ? "Online Version OLD/Classic" : "Offline Version (Codable)"
    ...
    //Classic/Old Version
    func configureDataSource() -> UITableViewDiffableDataSource<TableSection, FilmClassic> {
        let cellIdentifier = "Cell"

        let dataSource = UITableViewDiffableDataSource<TableSection, FilmClassic>(
            tableView: tableView,
    ...
    func updateSnapshot(animatingChange: Bool = false) {
        ...
        var snapshot = NSDiffableDataSourceSnapshot<TableSection, FilmClassic>()
        snapshot.appendSections([.main])
        snapshot.appendItems(viewModel.filmsOLD, toSection: .main)
